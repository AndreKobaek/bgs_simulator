from minions import Ghastcoiler, MicroBot, OmegaBuster, Sellemental
...
bottom_warband.add_minion(OmegaBuster())
bottom_warband.add_minion(MicroBot())
bottom_warband.add_minion(MicroBot())
bottom_warband.add_minion(MicroBot())
bottom_warband.add_minion(MicroBot())
bottom_warband.add_minion(MicroBot())
